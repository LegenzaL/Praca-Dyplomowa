...
dict_folders_allowed = os.path.join("slowniki", "dozwolone")
dict_folders_issuers = os.path.join("slowniki", "wystawcy")
...
for folder, weight in dict_folders_domain.items():
    ...
    for filename in os.listdir(f"slowniki/{folder}"):
        with open(f"slowniki/{folder}/{filename}", "r") as f:
            for line in f:
